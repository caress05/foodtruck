...
//Here's where the tacos are:
include 'includes/taco-array.php';
/*
//UNCOMMENT TO SEE TACOS
dumpDie $tacos;
*/
/*
...
{# shows form so user can enter their name.  Initial scenario
	get_header(); #defaults to header_inc.php	
        ...
        global $tacos; //allows us to see the taco data
        echo '<h3>Tacos!</h3>';
        ...
        foreach($tacos as $taco)
        {
            //dumpDie($taco);
            echo '
            <p><input type="checkbox" name="Taco[' . $taco->Price . ']" value="' . $taco->Meat . '"/> 
            ' . $taco->Number . ' ' . $taco->Meat . ' Tacos for only ' . $taco->Price . '</p>
            ';
        }
        echo '<input type="submit" name="submit" value="Please Enter Your Order">
...
{#form submits here we show entered name
    ...
    */
   //$myName = strip_tags($_POST['Taco']);# here's where we can strip out unwanted data
    
    echo '<h2 align="center">Tacos!</h2>';
    ...
    //$total = $_POST['Taco'];
	//echo '<h4 align="center"> Your total is: $' . $total . '</h4>';
	echo '<p align="center"><a href="' . THIS_PAGE . '">Place a New Order</a></p>';
